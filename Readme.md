...
# Configuration Script – INDTBEU868 - Rev. A

This **Configuration** script is designed for the **INDTBEU868** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – INDTBEU868 Rev. A

Este script de **Configuration** está diseñado para el modelo **INDTBEU868** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
